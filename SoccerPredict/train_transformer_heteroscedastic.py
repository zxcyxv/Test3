...
class HeteroscedasticTransformer(nn.Module):
    ...
    def __init__(self, input_size, d_model=128, nhead=4, num_layers=2, dropout=0.2,
        ...
        self.fourier_layer = FourierFeatureLayer(len(self.coord_indices), fourier_mapping_size, fourier_scale)
    ...
    def forward(self, x, return_all=False):
        ...
        # Selective Fourier Mapping: [γ(coords), original_features]
